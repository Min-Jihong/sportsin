...
export const BottomNavigation = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex justify-between items-center px-8 py-5 border-t border-gray-800">
...
const BottomNavigationItem = ({
  ...
  return (
    <Link href={href}>
      <Slot weight={isActive ? "fill" : "regular"} className="size-5" />
    </Link>
  );
};
