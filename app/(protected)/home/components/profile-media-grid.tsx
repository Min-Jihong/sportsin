...
import type { ProfileMedia } from "../lib/mock-profile";

interface ProfileMediaGridProps {
  media: ProfileMedia[];
  onMediaClick?: (media: ProfileMedia) => void;
}

export const ProfileMediaGrid = ({ media, onMediaClick }: ProfileMediaGridProps) => {
  if (media.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4">
        <p className="text-white/50 text-sm">업로드한 미디어가 없습니다</p>
      </div>
    );
  }
